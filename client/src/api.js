...
export const updateReview = async (projectId, reviewId, comment) => {
  const res = await fetch(`${API_URL}/deployments/${projectId}/reviews/${reviewId}`, {
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
...
export const updateReviewStatus = async (projectId, reviewId, status) => {
  const res = await fetch(`${API_URL}/deployments/${projectId}/reviews/${reviewId}/status`, {
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json' },
...
export const addReply = async (projectId, reviewId, reply) => {
  const res = await fetch(`${API_URL}/deployments/${projectId}/reviews/${reviewId}/replies`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
