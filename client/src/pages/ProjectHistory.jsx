    ...
    >
      <header className="flex justify-between items-end">
        <div>
          ...
          <p className="text-gray-400 font-medium">Tracking every deployment, comment, and resolution in real-time.</p>
        </div>
        
        <div className="flex items-center gap-3 bg-white/5 px-4 py-2 rounded-xl border border-white/5">
          <TrendingUp size={16} className="text-primary" />
          <span className="text-xs font-black uppercase tracking-widest">{events.length} TOTAL EVENTS</span>
        </div>
      </header>
      ...
      <section className="relative">
        ...
        <div className="space-y-4">
          {loading ? (
            <div className="text-center py-20 opacity-30 italic">Reading encrypted activity logs...</div>
          ) : (
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      ...
                      <h3 className="text-lg font-bold text-white leading-tight group-hover:text-primary transition-colors">{event.text}</h3>
                    </div>
                  ...
                  <div className="flex items-center gap-3 mt-4">
                    <div className="flex items-center gap-2 px-3 py-1 bg-white/5 rounded-full border border-white/5">
                      ...
                      <span className="text-[10px] font-bold text-gray-300">{event.user}</span>
                    </div>
