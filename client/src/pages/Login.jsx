    ...
    if (role === "teacher") {
      if (password === "p@ssw0rd") {
        localStorage.setItem(
          "user",
          JSON.stringify({ role: "teacher", name: "Admin" }),
        );
        navigate("/");
      } else {
      ...
      localStorage.setItem(
        "user",
        JSON.stringify({ role: "student", name: selectedStudent }),
      );
      navigate("/");
    }
  };
  ...
  return (
    <div className="fixed inset-0 bg-[#0a0f1d] flex items-center justify-center z-[200]">
      ...
      <motion.div
        ...
        className="glass-card w-full max-w-[420px] p-10 relative mx-4 sm:mx-auto"
      >
          ...
          >
            ...
            {role === "student" ? (
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase text-textMuted tracking-widest px-1">
                  Find your name
                </label>
                <select
        ...
        <footer className="mt-10 text-center">
          <p className="text-[9px] text-textMuted uppercase tracking-widest font-bold opacity-30">
            Portal v2.0
          </p>
        </footer>
      </motion.div>
